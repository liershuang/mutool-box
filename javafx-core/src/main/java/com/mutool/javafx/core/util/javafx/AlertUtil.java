...
import static com.mutool.javafx.core.javafx.helper.LayoutHelper.label;
import static com.mutool.javafx.core.javafx.helper.LayoutHelper.vbox;
...
public class AlertUtil {
    ...
    public static void showInfoAlert(String title, String message) {
        new FxDialog<>()
            ...
            .setTitle(title)
            .setBody(LayoutHelper.vbox(20, 0, Pos.CENTER, LayoutHelper.label(message, LABEL_MAX_WIDTH)))
    ...
    public static ButtonType confirm(
        ...
        FxDialog<Object> dialog = new FxDialog<>()
            ...
            .setOwner(FxApp.primaryStage)
            .setBody(LayoutHelper.vbox(10, 0, LayoutHelper.label(message)));
    ...
    public static String showInputAlertDefaultValue(String message, String defaultValue) {
        ...
        VBox body = LayoutHelper.vbox(10, 10, LayoutHelper.label(message, LABEL_MAX_WIDTH), textField);
