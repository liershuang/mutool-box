...
public class JavaFxXmlToObjectCodeService {
	public static String[] xmlToCode(String xmlStr) throws Exception {
		...
		controllerClassStrBuilder.append("package com.mutool.box.controller"+viewPackage+";\n");
		controllerClassStrBuilder.append("import com.mutool.box.view"+viewPackage+"."+classNameString+"View;\n");
		controllerClassStrBuilder.append("import com.mutool.box.services"+viewPackage+"."+classNameString+"Service;\n");
...
//		}
		...
		classStrBuilder.append("package com.mutool.box.view"+viewPackage+";\n");
		...
		serviceClassStrBuilder.append("package com.mutool.box.services"+viewPackage+";\n");
		serviceClassStrBuilder.append("import com.mutool.box.controller"+viewPackage+"."+classNameString+"Controller;\n");
