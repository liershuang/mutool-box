...
public class TransferToolTaskViewController extends TransferToolTaskViewView {
    ...
    public static FXMLLoader getFXMLLoader() {
        FXMLLoader fXMLLoader = new FXMLLoader(TransferToolTaskViewController.class.getResource("/com/xwintop/xJavaFxTool/fxmlView/developTools/xTransferTool/TransferToolTaskView.fxml"));
        return fXMLLoader;
    }
