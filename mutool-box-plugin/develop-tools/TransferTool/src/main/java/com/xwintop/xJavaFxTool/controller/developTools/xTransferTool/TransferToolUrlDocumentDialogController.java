...
public class TransferToolUrlDocumentDialogController extends TransferToolUrlDocumentDialogView {
    ...
    public static FXMLLoader getFXMLLoader() {
        FXMLLoader fXMLLoader = new FXMLLoader(TransferToolUrlDocumentDialogController.class.getResource("/com/xwintop/xJavaFxTool/fxmlView/developTools/xTransferTool/TransferToolUrlDocumentDialog.fxml"));
        return fXMLLoader;
    }
