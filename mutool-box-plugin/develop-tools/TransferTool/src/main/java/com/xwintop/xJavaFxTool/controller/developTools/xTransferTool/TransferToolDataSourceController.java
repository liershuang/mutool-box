...
public class TransferToolDataSourceController extends TransferToolDataSourceView {
    ...
    public static FXMLLoader getFXMLLoader() {
        FXMLLoader fXMLLoader = new FXMLLoader(TransferToolDataSourceController.class.getResource("/com/xwintop/xJavaFxTool/fxmlView/developTools/xTransferTool/TransferToolDataSource.fxml"));
        return fXMLLoader;
    }
